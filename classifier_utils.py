...
class iFLYTEKDERIVDataProcessor(DataProcessor):
  """Processor for the iFLYTEKData data set (GLUE version)."""
  ...
  def get_test_examples_from_local(self, local_data):
    return self._create_examples(local_data, 'test')

  def get_labels(self, data_dir):
    """See base class."""
    labels = []
    length = len(open(os.path.join(data_dir, 'labels.json'), 'r').readlines())
